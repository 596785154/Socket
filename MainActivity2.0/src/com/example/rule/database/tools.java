...
class  DBOpenHelper extends SQLiteOpenHelper{
	...
	private static final String p_plant_create =" create table "+ p_plant +" ("+plantType +" text not null,"+plantName+" text not null,"+tempuraturemin+" text,"+tempuraturemax+" text,"+humiditymin+" text,"+humiditymax+" text,"+youtu_tempuraturemin+" text,"+youtu_tempuraturemax+" text,"+youtu_humiditymin+" text,"+youtu_humiditymax+" text,"+atmospheremin+" text,"+atmospheremax+" text,"+lightmin+" text,"+lightmax+" text,"+co2min+" text,"+co2max+" text,primary key("+plantName+" ))";
